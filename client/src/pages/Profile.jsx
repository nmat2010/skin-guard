  ...
  return (
    <div className='profile-container'>
      <aside className='sidebar'> 
        <div className='profile-info'>
          ...
          <div className='profile-info-text'>
            <h2><b>{userData?.name || 'User'}</b></h2>
            <p><b>{userData?.email || 'user@example.com'}</b></p>
          </div>
        </div>
        <nav className='menu'>
      ...
      <div className='profile-content'>
          {state === 'default-view' && (
            <div>
              <img src='/images.jpg' alt='doggo' className='img'></img>
              <img width="220" height="200" src='/Untitled_Artwork.gif'></img>
