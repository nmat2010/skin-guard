  ...
  return (
    <div className='about-container'>
      <div className='product-title'>
        ...
        <p1 className='about-product-name'>SkinGuard</p1>
      </div>
      ...
      <div className='team-description'>
        ...
        <div className='team-members'>
          ...
          <a href="https://www.linkedin.com/in/tuan-tran-26a341322/?trk=contact-info" target="_blank">
            <p className='team-member'>Alex Tran</p>
          </a>
        ...
        <p className='seawolf-text' color='#486874'><b>"What's a Seawolf?" - "I'm a Seawolf!"</b></p>
      </div>
    </div>
  )
}
