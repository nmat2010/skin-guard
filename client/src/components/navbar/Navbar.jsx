...
<circle cx="20" cy="20" r="16" fill="#F5F5F5" stroke="#FCEFCC" strokeWidth="8"/>
</svg>
const product = "SkinGuard"
  ...
  return (
    <div className='navbar'>
      ...
      <div className='nav-logo'>
        <img src='/logo-border.png' className='logo-img'/>
        <p className='logo-name'>{product}</p>
      </div>
      </Link>
