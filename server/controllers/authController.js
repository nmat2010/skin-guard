...
export const register = async (req,res)=> {
    ...
    try {
        ...
        const mailOptions = {
            ...
            to: email,
            subject: 'Welcome to AI Dermatologist',
            text: `Welcome to AI Dermatologist website. Your account has been created with email id: ${email}`
        }
...
>>>>>>> fe80a82875357af125c7a5618d9fb4004f49245b
        ...
        return res.json({sucees:false, message: error.message});
    }
...
export const verifyEmail = async (req,res)=>{
    ...
    try {
        ...
        await user.save();
        return res.json({success: true, message: 'Email verififed successfully'})
